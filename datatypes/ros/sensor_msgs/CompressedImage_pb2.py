...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='ros/sensor_msgs/CompressedImage.proto',
  ...
  ,
  dependencies=[ros_dot_std__msgs_dot_Header__pb2.DESCRIPTOR,])
...
_COMPRESSEDIMAGE.fields_by_name['header'].message_type = ros_dot_std__msgs_dot_Header__pb2._HEADER
